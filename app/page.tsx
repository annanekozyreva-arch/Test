...
export default function CareerTestPage() {
  const questions = [
    ...
    { id: 9, text: "Если бы вам предоставили пост директора школы, на что бы вы обратили бы большее внимание:", optionA: "на сплоченность коллектива", optionB: "на создание необходимых удобств" },
